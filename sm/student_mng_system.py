...
class StudentManagementSystem:
    ...
    def add_grade(self):
        ...
        if student is not None:
            ...
            if course in student.courses:
                ...
                print(
                    'Grade Can not be added. Because this student have not enrolled to this course or the course does not exists in the System.')
        else:
    ...
    def load_data(self):
        if not os.path.exists('data.json'):
            ...
            create_file(initial_data, 'data.json')
